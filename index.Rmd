...
* [cv](https://github.com/georgeberry/georgeberry.github.io/blob/master/cv.pdf)

* george.e.berry at gmail dot com

## Work

I currently work as a Staff Data Scientist at Reddit, focusing on experimentation. 

For the first two months of 2021, I worked at a nonprofit focused on advancing progressive causes, where I was a lead Machine Learning Engineer. I lead the effort to build core modeling infrastructure in Tensorflow, which involved extending Tensorflow Probability. This infrastructure will be used to power polling and ad-testing models (hopefully through the 2022 midterms!).
